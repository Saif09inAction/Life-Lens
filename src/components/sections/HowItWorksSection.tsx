...
const steps = [
  {
    ...
    description: "The camera captures the surrounding environment in real time.",
    icon: "📷",
  },
  {
    number: "2",
    title: "AI processes video feed",
    description: "The AI model processes the video feed to detect objects, obstacles, and faces.",
    icon: "🤖",
  },
  {
    number: "3",
    title: "Ultrasonic measures obstacles",
    description: "The ultrasonic sensor measures the distance of nearby obstacles to improve navigation accuracy.",
    icon: "📏",
  },
  {
    number: "4",
    title: "Raspberry Pi processes & decides",
    description: "The Raspberry Pi processes all sensor data and determines the appropriate response.",
    icon: "🖥️",
  },
  {
    number: "5",
    title: "Audio guidance for blind users",
    description: "For blind users, the system provides audio guidance through the speaker about obstacles, directions, or recognized people.",
    icon: "🔊",
  },
  {
    number: "6",
    title: "Speech-to-text for deaf users",
    description: "For deaf users, the microphone captures speech and converts it into text displayed on the transparent display.",
    icon: "📝",
  },
  {
    number: "7",
    title: "MPU6050 fall detection",
    description: "The MPU6050 motion sensor monitors body movement and detects falls, enabling the system to trigger emergency alerts.",
    icon: "🔄",
  },
  {
    number: "8",
    title: "GPS & SOS alerts",
    description: "The GPS module tracks the user's location and sends SOS alerts with live location to family members when needed.",
    icon: "🛟",
  },
];
