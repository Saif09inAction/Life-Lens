        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          <div>
            <motion.div
              ...
              className="inline-flex items-center gap-2 rounded-full border border-white/20 bg-white/5 px-4 py-2 mb-6 backdrop-blur-sm"
            >
            ...
            <motion.h1
              ...
              className="font-display text-4xl font-bold tracking-tight text-white sm:text-5xl lg:text-6xl xl:text-7xl leading-[1.1]"
            >
              LifeLens –{" "}
            ...
            >
              <Link
                href="#solution"
                className="inline-flex items-center justify-center rounded-xl bg-white text-zinc-900 px-8 py-4 text-base font-semibold shadow-lg shadow-white/10 transition-all hover:bg-zinc-100"
              >
                View Solution
              </Link>
              <Link
                href="#how-it-works"
                className="inline-flex items-center justify-center rounded-xl border border-zinc-600 bg-transparent px-8 py-4 text-base font-semibold text-white transition-all hover:bg-white/5 hover:border-zinc-500"
              >
                Explore Technology
              </Link>
            </motion.div>
          ...
          >
            <div className="relative w-full max-w-md aspect-[4/5] flex flex-col items-center justify-center rounded-3xl border border-zinc-500/30 bg-zinc-900/90 backdrop-blur-xl p-10 shadow-2xl shadow-black/50">
